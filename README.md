...
#### main.py
É o módulo principal do programa, que tem como objetivo lê a expressão digitada ou um arquivo com a extensão `pc` interpretado pelo codigo do `paint_code` pelo usuário e passar a informação lida para o método `parser`.  Veja o trecho a seguir:
